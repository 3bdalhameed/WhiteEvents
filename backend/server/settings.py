...
SECRET_KEY = 'django-insecure-_mp=mb(9$#_+%j-*7td)2*_rp8rw$4apj&ffdg1*lq34h4o0+w'
...
# ===== CORS =====
CORS_ALLOW_ALL_ORIGINS = True  # allow all origins in dev; restrict in prod
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "abdalhmeed.dradkeh@gmail.com"
