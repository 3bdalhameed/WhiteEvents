...
export default function Footer() {
  ...
  return (
    <footer
      className="relative overflow-hidden border-t border-[var(--border-subtle)] bg-[var(--surface-0)] text-[var(--text-secondary)]"
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-[var(--text-primary)]">Contact Details</h3>
            <p className="text-sm text-[var(--text-tertiary)]">We’d love to hear about your event.</p>

            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-4 w-4 text-[var(--text-tertiary)]" />
                <span>
                  Mecca Street
                </span>
              </li>
          ...
          <div className="flex flex-col items-center justify-center gap-4 text-center">
            <img src={logo} alt="White Events Logo" className="theme-invert-logo w-28 drop-shadow sm:w-36" />
        ...
        {/* Divider + bottom row */}
        <div className="mt-12 border-t border-[var(--border-subtle)] pt-6 text-center text-xs text-[var(--text-tertiary)]">
