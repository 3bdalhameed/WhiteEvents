...
const Process = () => (
  <section className="relative bg-[#0b0b10] py-20">
    <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 lg:grid-cols-2 lg:px-12">
      <motion.div {...fade(0)}>
        <h2 className="font-serif text-3xl md:text-4xl font-bold tracking-tight"><span className="bg-gradient-to-r from-amber-200 via-rose-200 to-amber-100 bg-clip-text text-transparent">How It Works</span></h2>
