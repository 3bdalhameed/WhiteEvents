...
const m1 = "/gallery/albums/Events/3C0900FB-9A1C-479A-B6FB-8BE22B66B6F7.jpg";
const m2 = "/gallery/albums_thumbs/Yasmin & Ammar - The Ritz Carlton/1.webp";
const m3 = "/gallery/albums_thumbs/Zeina & Hussam - Four Seasons/IMG_5134.webp";
  ...
  return (
    ...
    >
      ...
      <div className="mb-12 px-6">
        ...
        <Link href="/gallery" className="inline-block mt-8">
          <button
            type="button"
          ...
          >
            VIEW OUR WORK
            <svg aria-hidden="true" className="h-4 w-4 -mr-0.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M5 12h14" />
            ...
            <div className="relative aspect-[4/5] w-full">
              ...
              <div className="pointer-events-none absolute inset-0 flex items-end opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                <div className="w-full p-5 text-left">
                  <h3 className="text-xl font-semibold text-white drop-shadow-sm">{item.title}</h3>
                  <p className="mt-1 max-w-[38ch] text-sm text-white/85">{item.desc}</p>
                </div>
              </div>
