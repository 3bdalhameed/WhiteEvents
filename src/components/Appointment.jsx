      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 md:grid-cols-5 md:gap-12">
        ...
        <div className="md:col-span-3 rounded-3xl bg-white/5 p-5 shadow-[0_10px_40px_rgba(0,0,0,0.45)] ring-1 ring-white/10 backdrop-blur-md">
          ...
          <div className="mt-4 grid grid-cols-7 gap-2 text-center text-xs font-medium text-neutral-400">
            {weekdayLabels.map((w) => (
              <div key={w} className="py-1 select-none">{w}</div>
            ))}
          </div>
        ...
        >
          ...
          <div>
            <label htmlFor="name" className="mb-1 block text-sm font-medium text-neutral-200">Full Name</label>
            <input
              id="name"
              type="text"
              className={`w-full rounded-lg border bg-white/5 p-3 text-neutral-100 placeholder:text-neutral-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/40 ${errors.name && !submitted ? "border-red-400/50" : "border-white/10"}`}
          ...
          <div>
            <label htmlFor="phone" className="mb-1 block text-sm font-medium text-neutral-200">Phone Number</label>
            <input
              id="phone"
              type="tel"
              className={`w-full rounded-lg border bg-white/5 p-3 text-neutral-100 placeholder:text-neutral-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/40 ${errors.phone && !submitted ? "border-red-400/50" : "border-white/10"}`}
          ...
          <div>
            ...
            <input
              readOnly
              value={selectedDate || "—"}
              className={`w-full cursor-not-allowed rounded-lg border bg-white/5 p-3 text-neutral-200 ${errors.date && !submitted ? "border-red-400/50" : "border-white/10"}`}
            />
          ...
          <div>
            ...
            <input
              readOnly
              value={selectedTime || "—"}
              className={`w-full cursor-not-allowed rounded-lg border bg-white/5 p-3 text-neutral-200 ${errors.time && !submitted ? "border-red-400/50" : "border-white/10"}`}
            />
            {errors.time && !submitted && <p className="mt-1 text-xs text-red-300">{errors.time}</p>}
          </div>

          <div>
            <label htmlFor="details" className="mb-1 block text-sm font-medium text-neutral-200">Additional Details</label>
            <textarea
              id="details"
              rows={4}
